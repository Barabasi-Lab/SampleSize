...
singularity run -B "/scratch:/scratch,/work:/work" $RSTUDIO_IMAGE Rscript /home/j.aguirreplans/Projects/Scipher/SampleSize/scripts/calculate_separation.R -a /home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables/tables_differential_coexpression/"$folder"/nodes_by_type_and_category_and_size/codina_ppi_lcc_nodes_separation_type_"$type"_size_"$size".txt -b /work/ccnr/j.aguirreplans/data/PPI/PPI_2022_04042022.csv -c /home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables/tables_differential_coexpression/"$folder"/separation_by_type_and_size/codina_ppi_lcc_separation_type_"$type"_size_"$size".txt
