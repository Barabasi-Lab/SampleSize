...
Tutorial based on: 
https://bioconductor.org/packages/devel/bioc/vignettes/GenomicDataCommons/inst/doc/overview.html 
https://sciwiki.fredhutch.org/compdemos/GDC_Data_Download/
...
cases_df = cbind(cases_df$id, cases_df$disease_type, cases_df$project$project_id, cases_df$project$disease_type, cases_samples_info_df$sample_id, cases_samples_info_df$sample_type, cases_df$demographic$gender, cases_df$demographic$race, cases_df$demographic$ethnicity, cases_df$demographic$vital_status, cases_df$demographic$age_at_index) %>% as.data.frame() %>% rename("id"="V1", "disease_type"="V2", "project_id"="V3", "project_disease_type"="V4", "sample_id"="V5", "sample_type"="V6", "gender"="V7", "race"="V8", "ethnicity"="V9", "vital_status"="V10", "age_at_index"="V11")
...
ID.map %>% fwrite(manifest_idmap_file)
```
