...
samples_baseline = metadata_RNA_0m$Scipher_id.visit.batch
...
sample_per_responder_baseline = responder_euler_df$Scipher_id.visit.batch
...
sample_per_nonresponder_baseline = nonresponder_euler_df$Scipher_id.visit.batch
...
* All samples at baseline, no matter the batch (`r length(samples_baseline)`)
...
```{r, echo=FALSE, results='hide'}
group_to_samples = list("complete_dataset"=complete_dataset, "samples_baseline"=samples_baseline, "sample_per_patient_baseline"=sample_per_patient_baseline, "responder_baseline"=sample_per_responder_baseline, "nonresponder_baseline"=sample_per_nonresponder_baseline)
n_repetitions = 5
