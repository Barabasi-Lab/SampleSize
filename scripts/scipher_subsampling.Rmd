...
```{r}
group_to_samples = list("complete.dataset"=complete_dataset, "sample.per.patient.all.visits"=sample_per_patient_all_visits, "sample.per.patient.baseline"=sample_per_patient_baseline, "responder.baseline"=sample_per_responder_baseline, "nonresponder.baseline"=sample_per_nonresponder_baseline)
n_repetitions = 10
