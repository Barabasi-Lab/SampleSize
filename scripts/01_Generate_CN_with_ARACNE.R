...
option_list = list(
  ...
  make_option(c("-o", "--output_file"), type="character", default="gene_coexpression_network_ARACNE.net", 
              help="output file [default= %default]", metavar="character")
); 
# Example of execution
# Rscript /Users/quim/Dropbox/Postdoc/Projects/Scipher/SampleSizeEffect/scripts/01_Generate_CN_with_ARACNE.R -f /Users/quim/Documents/DATA/BioGroup/Scipher/data/bootstrap/nonresponders/RNAseq_NonResponders_sample_10_rep_1.txt -o /Users/quim/Documents/DATA/BioGroup/Scipher/data/bootstrap_ARACNE/RNAseq_NonResponders_sample_10_rep_1.net
...
setDT(rnaseq.t, keep.rownames = 'gene')[]
