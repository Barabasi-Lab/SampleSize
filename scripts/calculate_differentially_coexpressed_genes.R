...
coexpression_df_D = read_coexpression_network(coexpression_network_file=coexpression_network_file_D, method=method_D, threshold=threshold)
coexpression_df_N = read_coexpression_network(coexpression_network_file=coexpression_network_file_N, method=method_N, threshold=threshold)
end_time <- Sys.time()
...
# Nodes = ClusterNodes(DiffNet = DiffNet_cl, cutoff.external = 0, cutoff.internal = 1)
# end_time <- Sys.time()
# time_diff = end_time - start_time
# print(time_diff)
# 
...
cols = c("Node", "Phi", "pval_Phi", "Group_pval_Phi", "Phi_tilde", "pval_Phi_Tilde", "Group_pval_Phi_tilde", "type_correlation")
