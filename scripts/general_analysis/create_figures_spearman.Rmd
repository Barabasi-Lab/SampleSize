...
plots_dir <- '/home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/plots_spearman'
tables_dir <- '/home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables_spearman'
...
my_geom_label_theme <- geom_label_repel(
  aes(col=rgb_col),
...
topology_results_file = paste(input_dir, '/topology_results_', type_data_selection, '.txt', sep='')
results_selected_df = fread(topology_results_file)
topology_results_by_size_file = paste(input_dir, '/topology_results_mean_', type_data_selection, '.txt', sep='')
topology_results_selected_by_size_df = fread(topology_results_by_size_file)
predictions_file = paste(input_dir, '/predictions_', type_data_selection, '.txt', sep='')
predicted_results_df = fread(predictions_file)
analytical_results_file = paste(input_dir, '/analytical_model_results_', type_data_selection, '.txt', sep='')
topology_results_selected_analytical_df = fread(analytical_results_file)
analytical_summary_file = paste(input_dir, '/analytical_model_summary_', type_data_selection, '.txt', sep='')
analytical_model_summary_df = fread(analytical_summary_file)
analytical_regression_results_file = paste(input_dir, '/analytical_model_regression_results_', type_data_selection, '.txt', sep='')
...
input_dir = paste('/home/j.aguirreplans/Projects/Scipher/SampleSize/scripts/SampleSizeShiny/data/example_', type_data_selection, sep = '')
topology_results_file = paste(input_dir, '/', 'topology_results_norm_', topology_type_normalization, '_', type_data_selection, '.txt', sep='')
results_selected_norm_df = fread(topology_results_file)
topology_results_by_size_file = paste(input_dir, '/', 'topology_results_mean_norm_', topology_type_normalization, '_', type_data_selection, '.txt', sep='')
topology_results_selected_by_size_norm_df = fread(topology_results_by_size_file)
predictions_file = paste(input_dir, '/', 'predictions_', topology_type_normalization, '_', type_data_selection, '.txt', sep='')
predicted_results_norm_df = fread(predictions_file)
analytical_results_file = paste(input_dir, '/', 'analytical_model_results_', topology_type_normalization, '_', type_data_selection, '.txt', sep='')
...
results_curve_df = results_selected_norm_df %>%
  ...
  dplyr::mutate(geom_text_repel_label = case_when(
      type_dataset == "R. arthritis" & size == 240 & rep == 1 ~ "R. arthritis",
      type_dataset == "GTEx: Breast" & size == 140 & rep == 1 ~ "GTEx: Breast",
      type_dataset == "GTEx: Whole blood" & size == 700 & rep == 1 ~ "GTEx: Whole blood",
      type_dataset == "GTEx: Lung" & size == 560 & rep == 1 ~ "GTEx: Lung",
      type_dataset == "TCGA: Breast cancer" & size == 600 & rep == 1 ~ "TCGA: Breast cancer",
      type_dataset == "TCGA: Lung cancer" & size == 460 & rep == 1 ~ "TCGA: Lung cancer",
      TRUE ~ ""
    ))
...
plot_file = paste(plots_dir, "/curve_", type_data_selection, ".png", sep="")
ggsave(
  plot_file,
  plot=curve_plot,
  dpi = 1200,
...
```{r}
datasets_selected = c("gtex:breast.mammary.tissue", 
                      "tcga:tcga-brca_female")
...
plot_file = paste(plots_dir, "/curve_", type_data_selection, "_lessdatasets.png", sep="")
ggsave(
  plot_file,
...
plot_file = paste(plots_dir, "/scaling_relation_", type_data_selection, ".png", sep="")
ggsave(
  plot_file,
...
plot_file = paste(plots_dir, 
                  "/scaling_relation_", type_data_selection, "_lessdatasets.png", 
                  sep="")
ggsave(
  plot_file,
...
# Process data
stretched_exponential_regression_proc_df <- stretched_exponential_regression_df %>% 
  inner_join((topology_results_selected_analytical_df %>% dplyr::select(type_dataset, model, slope, intercept, a, b) %>% unique()), by=c("type_dataset", "model")) %>%
  dplyr::filter((type_dataset %in% datasets_selected) & (model == model_selected)) %>%
  dplyr::mutate(type_dataset = dplyr::recode(type_dataset, !!!dataset2name)) %>%
  dplyr::inner_join( (name2color %>% as.data.frame() %>% dplyr::rename("rgb_col"=".") %>% tibble::rownames_to_column("type_dataset")), by=c("type_dataset") )
...
plot_file = paste(plots_dir, "/regression_", type_data_selection, ".png", sep="")
ggsave(
  plot_file,
...
plot_file = paste(plots_dir, "/prediction_", type_data_selection, ".png", sep="")
...
plot_file = paste(plots_dir, "/prediction_", type_data_selection, "_lessdatasets.png", sep="")
...
plot_file = paste(plots_dir, "/comparison_models_", type_data_selection, "_", dataset_selected, ".png", sep="")
...
scaling_relation_comparison_df = scaling_relation_comparison_df %>%
  ...
  mutate(type_dataset = replace(type_dataset, 
                                ...
                                "TCGA: Breast cancer")) %>%
  mutate(type_dataset = replace(type_dataset, 
                                type_dataset == "gtex:breast.mammary.tissue", 
                                "GTEx: Breast")) %>%
  inner_join( (name2color %>% 
                 as.data.frame() %>% 
                 dplyr::rename("rgb_col"=".") %>% 
...
plot_file = paste(plots_dir, "/comparison_pl_ed_", type_data_selection, "_", dataset_selected, ".png", sep="")
ggsave(
  plot_file,
...
plot_file = paste(plots_dir, "/goodnessfit_model_", type_data_selection, "_", dataset_selected, ".png", sep="")
...
plot_file = paste(plots_dir, "/goodnessfit_2models_", type_data_selection, "_", dataset_selected, ".png", sep="")
...
a_vs_fraction_corr_file = paste(tables_dir, 
                                "/a_vs_fraction_sig_correlations_", type_data_selection, ".txt", 
                                sep = "")
...
sample_size_vs_a_plot_df = sample_size_vs_a_df %>% 
  ...
  mutate(dataset_name = 
           replace(dataset_name, 
                   dataset_name == "gtex:breast.mammary.tissue", 
                   "GTEx: Breast")) %>%
...
plot_file <- paste(plots_dir,
                   "/a_vs_fraction_sig_correlations_", type_data_selection, ".png",
                   sep="")
ggsave(
  plot_file,
...
a_vs_fraction_sig_correlations_lessdatasets_plot <- sample_size_vs_a_plot_lessdatasets_df %>%
    ...
    geom_abline(aes(slope = slope_avsfr,
                ...
                col = "gray50",
                show.legend = FALSE) +
  annotate("text", x = 2.25, y = 0.7, label = lm_cor_result_avsfr, size = 5) +
  xlab(expression(alpha)) +
  ylab("Frac. correlations above 0.2") +
  theme_linedraw() +
  theme(aspect.ratio = 1, 
...
plot_file <- paste(plots_dir,
                   "/a_vs_fraction_sig_correlations_", type_data_selection, "_lessdatasets.png",
                   sep="")
ggsave(
  plot_file,
...
a_vs_ss_plot <- sd_genes_vs_ss_df %>%
    ...
    annotate("text", x = 2.8, y = 0.34, label = lm_cor_result_ssvsa, size = 5) +
...
a_vs_ss_lin_lin_plot <- sd_genes_vs_ss_df %>%
    ...
    scale_color_manual(values = c("gray50")) +
    #annotate("text", x = 4500, y = 2.05, label = lm_cor_result_ssvsa, size = 5) +
    annotate("text", x = 1000, y = 2, label = lm_cor_result_ssvsa, size = 5) +
...
a_vs_ss_log_lin_plot <- sd_genes_vs_ss_df %>%
    ...
    scale_color_manual(values = c("gray50")) +
    #annotate("text", x = 4500, y = 2.05, label = lm_cor_result_ssvsa, size = 5) +
    annotate("text", x = 1000, y = 0.3, label = lm_cor_result_ssvsa, size = 5) +
    xlab("n to get 50% sig. links") +
    ylab(expression(bold(log10(alpha)))) +
    theme_linedraw() +
    theme(aspect.ratio = 1, 
...
a_vs_ss_lin_log_plot <- sd_genes_vs_ss_df %>%
    ...
    scale_color_manual(values = c("gray50")) +
    #annotate("text", x = 4500, y = 2.05, label = lm_cor_result_ssvsa, size = 5) +
    annotate("text", x = 2.8, y = 2.1, label = lm_cor_result_ssvsa, size = 5) +
    xlab("log10(n) to get 50% sig. links") +
    ylab(expression(bold(alpha))) +
    theme_linedraw() +
    theme(aspect.ratio = 1, 
...
cv_vs_ss_plot <- sd_genes_vs_ss_df %>%
    ...
    geom_abline(aes(slope = slope_cvvsss,
              ...
              show.legend = FALSE) +
    scale_color_manual(values = c("gray50")) +
    annotate("text", x = 1000, y = 0.41, label = lm_cor_result_cvvsss, size = 5) +
...
sd_vs_ss_plot <- sd_genes_vs_ss_df %>%
    ...
    geom_abline(aes(slope = slope_sdvsss,
              ...
              show.legend = FALSE) +
    scale_color_manual(values = c("gray50")) +
    annotate("text", x = 1000, y = 0.93, label = lm_cor_result_sdvsss, size = 5) +
    xlab("Num. samples for 50% sig. links") +
...
results_gtex_wb = all_results_df %>% 
  filter((type_dataset == dataset_selected) & (threshold == threshold_selected) & (method == method_selected) & (type_correlation %in% c("weak-moderate-strong-very strong", "moderate-strong-very strong", "strong-very strong", "very strong")))
...
plot_file = paste(plots_dir, "/correlation_levels_", type_data_selection, "_data_gtexwholeblood.png", sep="")
ggsave(
  plot_file,
