...
For networks based on different methods (Pearson, Spearman, ARACNe, GENIE3) and data sets, read the files where the select strong correlations have already been selected as the ones above a given threshold (e.g., 0.6 for pearson) at all networks of the maximum sample size (e.g., 120).
Then, calculate the percentage of remaining strong correlations at lower sample sizes
