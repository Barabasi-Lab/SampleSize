...
predicted_results_mod_df %>%
  ...
  xlab("Num. samples") +
  ylab("Frac. sign. strong correlations") +
...
```{r load_sd}
sd_file <- "/home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables/analysis_sd_coexpression_weight_filtered_by_strong_correlations_tcga_TCGA-BRCA_female_spearman.txt"
sd_df <- data.table::fread(sd_file, header = TRUE)
```
