...
num_edges_num_samples_file = "/home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables/scipher_pearson_pval_0.05_num_edges_vs_num_samples.txt"
topology_scipher_pearson_df %>% select(size, rep, num_edges) %>% arrange(size, rep) %>% fwrite(num_edges_num_samples_file)
