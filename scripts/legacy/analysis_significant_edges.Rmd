...
We filter the results by focusing on the dataset of TCGA, method Pearson and p-value threshold 0.05:

```{r}
# Filter by results of the dataset obtained by Pearson correlation and threshold 0.05
selected_dataset = "tcga"
selected_type_dataset = "TCGA"
selected_type_correlation = "all"
topology_pearson_df = topology_df %>% filter((dataset == selected_dataset) & (type_dataset == selected_type_dataset) & (method == "pearson") & (type_correlation == selected_type_correlation) & (threshold == 0.05))
head(topology_pearson_df)

# Write small table with results
output_tables_dir = "/home/j.aguirreplans/Projects/Scipher/SampleSize/data/out/tables"
num_edges_num_samples_file = paste(output_tables_dir, paste(selected_dataset, "_pearson_pval_0.05_num_edges_vs_num_samples.txt", sep=""), sep="/")
topology_pearson_df %>% select(size, rep, num_edges) %>% arrange(size, rep) %>% fwrite(num_edges_num_samples_file)

# Calculate mean and median of the number of edges per size
topology_pearson_by_size_df = topology_pearson_df %>%
  group_by(size) %>%
  summarise_at(vars(num_edges), list(mean=mean, median=median, sd=sd, var=var)) %>%
  arrange(size)
topology_pearson_by_size_df$mean.upper = topology_pearson_by_size_df$mean + topology_pearson_by_size_df$var
topology_pearson_by_size_df$mean.lower = topology_pearson_by_size_df$mean - topology_pearson_by_size_df$var
...
```{r}
# Linear-x Linear-y
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    #geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data = topology_pearson_by_size_df, aes(x=size, y=mean, group=1), col=2, lwd=1) +
...
plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_num_edges_vs_num_samples.png", sep=""), sep="/")
ggsave(
...
# Log-x Linear-y
ggplot(topology_pearson_df, aes(x=log(size), y=num_edges)) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    #geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data = topology_pearson_by_size_df, aes(x=log(size), y=mean, group=1), col=2, lwd=1) +
    #ggtitle("Num. of significant edges vs. Num. of samples") +
    labs(x="Number of samples (Ln)", y = "Number of significant edges") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom", legend.title=element_blank())

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_num_edges_vs_log_num_samples.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
# Linear-x Log-y
ggplot(topology_pearson_df, aes(x=size, y=log(num_edges))) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    #geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data = topology_pearson_by_size_df, aes(x=size, y=log(mean), group=1), col=2, lwd=1) +
    #ggtitle("Num. of significant edges vs. Num. of samples") +
    labs(x="Number of samples", y = "Number of significant edges (Ln)") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom", legend.title=element_blank())

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_log_num_edges_vs_num_samples.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
# Log-x Log-y
ggplot(topology_pearson_df, aes(x=log(size), y=log(num_edges))) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    #geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data = topology_pearson_by_size_df, aes(x=log(size), y=log(mean), group=1), col=2, lwd=1) +
    #ggtitle("Num. of significant edges vs. Num. of samples") +
    labs(x="Number of samples (Ln)", y = "Number of significant edges (Ln)") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom", legend.title=element_blank())

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_log_num_edges_vs_log_num_samples.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
lm_log = summary(lm(num_edges~log(size), data=topology_pearson_df))
...
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    ...
    geom_line(data=topology_pearson_df, aes(x=size, y=(log(size)*coef(lm_log)[2] + coef(lm_log)[1]), color=formula_name), size=1) +
    #ggtitle("Num. of significant edges vs. Num. of samples") +
    labs(x="Number of samples", y = "Number of significant edges") +
    theme_linedraw() +
...
plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_num_edges_vs_num_samples_linear_fit.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 15000,
...
```{r}
lm_lin = summary(lm(num_edges~size, data=topology_pearson_df))

# Plot curve including linear fit model
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data=topology_pearson_df, aes(x=size, y=(size*coef(lm_lin)[2] + coef(lm_lin)[1]), color="Linear model"), size=1) +
    labs(x="Number of samples", y = "Number of significant edges") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom") +
    scale_color_manual(name = "",
...
lm_exp = summary(lm(num_edges~exp(-size), data=topology_pearson_df))

# Plot curve including exponential fit model
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data=topology_pearson_df, aes(x=size, y=(exp(-size)*coef(lm_exp)[2] + coef(lm_exp)[1]), color="Exponential model"), size=1) +
    labs(x="Number of samples", y = "Number of significant edges") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom") +
    scale_color_manual(name = "",
...
fit_pl = fit_power_law(topology_pearson_df$num_edges)

# Plot curve including power law fit model
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    geom_point(alpha=0.5, size=3, col=2, fill=2) +
    geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, color="Mean"), size=1) +
    geom_line(data=topology_pearson_df, aes(x=size, y=size**(-fit_pl$alpha), color="Power law model"), size=1) +
    labs(x="Number of samples", y = "Number of significant edges") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom") +
    scale_color_manual(name = "",
...
ggplot(prediction_num_edges_df) + 
    ...
    #lims(x=c(0, 126000), y=c(0, total_num_edges)) +
...
plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_num_edges_vs_num_samples_linear_fit_prediction.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 15000,
...
```{r}
num_samples = unique(topology_pearson_df$size)[order(unique(topology_pearson_df$size))]
...
for(n in num_samples){
  ...
  topology_specific_df = topology_pearson_df %>% filter(size<=n)
...
prediction_error_df %<>% inner_join(topology_pearson_by_size_df %>% select("size", "mean"), c("size"="size"))
...
prediction_error_df$error = abs(prediction_error_df$predicted_num_edges - prediction_error_df$mean) / prediction_error_df$mean
...
plot_error_num_edges_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_error_prediction_num_edges.png", sep=""), sep="/")
ggsave(
...
plot_error_num_edges_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_error_prediction_reduced_num_edges.png", sep=""), sep="/")
ggsave(
  plot_error_num_edges_file,
  dpi = 1200,
  width = 15000,
...
plot_error_num_edges_file = paste(plots_dir, paste(selected_dataset, "_pearson_pval_0.05_error_prediction_reduced_num_edges_with_dots.png", sep=""), sep="/")
ggsave(
  plot_error_num_edges_file,
  dpi = 1200,
  width = 15000,
...
```{r}
topology_pearson_pval_df = topology_df %>% filter((dataset == selected_dataset) & (type_dataset == selected_type_dataset) & (method == "pearson") & (type_correlation == selected_type_correlation))
head(topology_pearson_pval_df)

# Calculate mean and median of the number of edges per size
topology_pearson_pval_by_size_df = topology_pearson_pval_df %>%
  group_by(threshold, size) %>%
  summarise_at(vars(num_edges), list(mean=mean, median=median, sd=sd, var=var)) %>%
  arrange(size)
topology_pearson_pval_by_size_df$mean.upper = topology_pearson_pval_by_size_df$mean + topology_pearson_pval_by_size_df$var
topology_pearson_pval_by_size_df$mean.lower = topology_pearson_pval_by_size_df$mean - topology_pearson_pval_by_size_df$var

```

```{r}
# Linear-x Linear-y
topology_pearson_pval_df$threshold = as.character(topology_pearson_pval_df$threshold)
topology_pearson_pval_by_size_df$threshold = as.character(topology_pearson_pval_by_size_df$threshold)
ggplot(topology_pearson_pval_df, aes(x=size, y=num_edges, group=threshold, col=threshold)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_pearson_pval_by_size_df, aes(x=size, y=mean, group=threshold, col=threshold), size=1) +
    labs(x="Number of samples", y = "Number of significant edges", color="P-value threshold") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom")

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_num_edges_vs_num_samples_by_pval.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
# Log-x Linear-y
ggplot(topology_pearson_pval_df, aes(x=log(size), y=num_edges, group=threshold, col=threshold)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_pearson_pval_by_size_df, aes(x=log(size), y=mean, group=threshold, col=threshold), size=1) +
    labs(x="Number of samples (Ln)", y = "Number of significant edges", color="P-value threshold") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom")

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_num_edges_vs_log_num_samples_by_pval.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
# Linear-x Log-y
ggplot(topology_pearson_pval_df, aes(x=size, y=log(num_edges), group=threshold, col=threshold)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_pearson_pval_by_size_df, aes(x=size, y=log(mean), group=threshold, col=threshold), size=1) +
    labs(x="Number of samples", y = "Number of significant edges (Ln)", color="P-value threshold") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom")

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_log_num_edges_vs_num_samples_by_pval.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
# Log-x Log-y
ggplot(topology_pearson_pval_df, aes(x=log(size), y=log(num_edges), group=threshold, col=threshold)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_pearson_pval_by_size_df, aes(x=log(size), y=log(mean), group=threshold, col=threshold), size=1) +
    labs(x="Number of samples (Ln)", y = "Number of significant edges (Ln)", color="P-value threshold") +
    theme_linedraw() +
    theme(plot.title =  element_text(size = 17, face="bold"), axis.title = element_text(size = 16, face="bold"), axis.text = element_text(size = 15), legend.text = element_text(size = 14), legend.position="bottom")

plot_num_edges_num_samples_file = paste(plots_dir, paste(selected_dataset, "_pearson_log_num_edges_vs_log_num_samples_by_pval.png", sep=""), sep="/")
ggsave(
  plot_num_edges_num_samples_file,
  dpi = 1200,
  width = 13000,
...
```{r}
topology_method_df = topology_df %>% filter((dataset == "scipher") & (type_dataset == "complete.dataset") & ((threshold == 0.05) | (threshold == 0)) & is.na(disparity))
head(topology_method_df)

# Calculate mean and median of the number of edges per size
topology_method_by_size_df = topology_method_df %>%
  group_by(method, size) %>%
  summarise_at(vars(num_edges), list(mean=mean, median=median, sd=sd, var=var)) %>%
  arrange(size)
topology_method_by_size_df$mean.upper = topology_method_by_size_df$mean + topology_method_by_size_df$var
topology_method_by_size_df$mean.lower = topology_method_by_size_df$mean - topology_method_by_size_df$var
```

```{r}
# Linear-x Linear-y
ggplot(topology_method_df, aes(x=size, y=num_edges, group=method, col=method)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_method_by_size_df, aes(x=size, y=mean, group=method, col=method), size=1) +
...
# Log-x Linear-y
ggplot(topology_method_df, aes(x=log(size), y=num_edges, group=method, col=method)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_method_by_size_df, aes(x=log(size), y=mean, group=method, col=method), size=1) +
...
# Linear-x Log-y
ggplot(topology_method_df, aes(x=size, y=log(num_edges), group=method, col=method)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_method_by_size_df, aes(x=size, y=log(mean), group=method, col=method), size=1) +
...
# Log-x Log-y
ggplot(topology_method_df, aes(x=log(size), y=log(num_edges), group=method, col=method)) + 
    geom_point(alpha=0.5, size=3) +
    geom_line(data = topology_method_by_size_df, aes(x=log(size), y=log(mean), group=method, col=method), size=1) +
...
```{r}
topology_pearson_dataset_df = topology_df %>% filter(((dataset == "gtex") | (dataset == "scipher")) & ((type_dataset == "Whole.Blood") | (type_dataset == "complete.dataset")) & (method == "pearson") & (threshold == 0.05) & is.na(disparity))
...
```{r}
#network_file = "/scratch/j.aguirreplans/Scipher/SampleSize/networks_scipher/complete.dataset/pearson_complete.dataset_size_20_rep_1.net"
network_file = "/scratch/j.aguirreplans/Scipher/SampleSize/networks_scipher/complete.dataset/pearson_complete.dataset_all_samples.net"
...
ggplot(topology_pearson_df, aes(x=size, y=num_edges)) + 
    ...
    geom_line(data=topology_pearson_by_size_df, aes(x=size, y=mean, colour="Mean"), size=1) +
...
plot_significant_edges_file = paste(plots_dir, "tcga_pearson_pval_0.05_analytical_estimate_num_edges_vs_num_samples.png", sep="/")
ggsave(
...
for(num_samples in num_samples_list){
  ...
  print(num_samples)
  network_file = paste(networks_dir, paste("pearson_complete.dataset_size_", num_samples, "_rep_1.net", sep=""), sep="/")
...
```{r, eval=FALSE}
networks_dir = "/scratch/j.aguirreplans/Scipher/SampleSize/networks_scipher/complete.dataset"
network_file = paste(networks_dir, paste("pearson_complete.dataset_all_samples.net", sep=""), sep="/")
