...
compilation_samples_output_file = paste(sampling_dir, 'tcga_TCGA.txt', sep='/')
...
for (project_id in project_ids){
  ...
  all_samples_output_file = paste(project_sampling_dir, paste('tcga_', project_id, '_all_samples.txt', sep=''), sep='/')
  output_file_name = paste(paste(paste('tcga', project_id, sep="_")))
  compilation_samples_output_file = paste(sampling_dir, paste(paste('tcga', project_id, sep="_"), '.txt', sep=''), sep='/')
