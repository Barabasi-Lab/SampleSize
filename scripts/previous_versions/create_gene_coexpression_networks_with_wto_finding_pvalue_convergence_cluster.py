...
def parse_options():
    ...
    parser = optparse.OptionParser("create_gene_coexpression_networks_cluster.py")
    ...
    if options.input_dir is None or options.output_dir is None or options.rnaseq_file is None:
...
def create_gene_coexpression_networks(options):
    ...
    script_file = os.path.join(src_path, 'create_gene_coexpression_network_with_wto_finding_pvalue_convergence.R')
