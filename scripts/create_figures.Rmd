...
a_vs_fraction_sig_correlations_plot = sample_size_vs_a_df %>% 
  ...
  geom_point(data = . %>% filter(type_dataset == "TCGA: Lung cancer"), color = "#D55E00") +
  ...
  geom_point(data = . %>% filter(type_dataset == "GTEx: Lung"), color = "#E69F00") +
  ...
  geom_text_repel(
    ...
    data = subset((sample_size_vs_a_df %>% filter(type_correlation == type_correlation_selected) %>% mutate(type_dataset = replace(type_dataset, type_dataset == "gtex:lung", "GTEx: Lung"))), type_dataset == "GTEx: Lung"),
  ...
  geom_text_repel(
    data = subset((sample_size_vs_a_df %>% filter(type_correlation == type_correlation_selected) %>% mutate(type_dataset = replace(type_dataset, type_dataset == "scipher:scipher.sample.per.patient.baseline", "R. arthritis"))), type_dataset == "R. arthritis"),
  ...
  geom_text_repel(
    data = subset((sample_size_vs_a_df %>% filter(type_correlation == type_correlation_selected) %>% mutate(type_dataset = replace(type_dataset, type_dataset == "tcga:tcga-brca_female", "TCGA: Breast cancer"))), type_dataset == "TCGA: Breast cancer"),
  ...
  geom_text_repel(
    ...
    data = subset((sample_size_vs_a_df %>% filter(type_correlation == type_correlation_selected) %>% mutate(type_dataset = replace(type_dataset, type_dataset == "tcga:tcga-luad", "TCGA: Lung cancer"))), type_dataset == "TCGA: Lung cancer"),
...
for (x in 1:length(parameters)){
  ...
  param_vs_a_plot = sd_genes_vs_a_df %>%
    ...
    geom_point() +
    geom_point(data = . %>% filter(dataset_name == "TCGA: Lung cancer"), color = "#56B4E9") +
    ...
    geom_point(data = . %>% filter(dataset_name == "GTEx: Lung"), color = "#E69F00") +
    ...
    theme(aspect.ratio=1, plot.title =  element_text(size = 15, face="bold"), axis.title = element_text(size = 14, face="bold"), axis.text = element_text(size = 13), legend.text = element_text(size = 13), legend.title=element_text(size=14, face="bold")) +
    geom_text_repel(
      data = subset((sd_genes_vs_a_df %>% mutate(dataset_name = replace(dataset_name, dataset_name == "gtex:lung", "GTEx: Lung"))), dataset_name == "GTEx: Lung"),
    ...
    geom_text_repel(
      data = subset((sd_genes_vs_a_df %>% mutate(dataset_name = replace(dataset_name, dataset_name == "scipher:scipher.sample.per.patient.baseline", "R. arthritis"))), dataset_name == "R. arthritis"),
    ...
    geom_text_repel(
      data = subset((sd_genes_vs_a_df %>% mutate(dataset_name = replace(dataset_name, dataset_name == "tcga:tcga-brca_female", "TCGA: Breast cancer"))), dataset_name == "TCGA: Breast cancer"),
    ...
    geom_text_repel(
      data = subset((sd_genes_vs_a_df %>% mutate(dataset_name = replace(dataset_name, dataset_name == "tcga:tcga-luad", "TCGA: Lung cancer"))), dataset_name == "TCGA: Lung cancer"),
...
# Use patchwork to concatenate plots
(violinplot_ppi_coexpression_by_distances /
  violinplot_ppi_coexpression_by_types /
  auc_plot) + 
  plot_annotation(tag_levels = 'A') & # Include letters 
    theme(plot.tag = element_text(face = 'bold')) # that are bold
