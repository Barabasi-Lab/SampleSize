...
for(sample_type_selected in unique(metadata_df$sample_type_simplified)){
  ...
  samples_selected_by_type = unique((metadata_df %>% filter(sample_type_simplified == sample_type_selected))$participant_sample)
...
for(sample_type_selected in unique(metadata_df$sample_type_simplified)){
  ...
  for (project_id_selected in projects){
    ...
    for (sex in sex_types){
      ...
      if (sex == ""){
        samples_project = unique((metadata_df %>% filter((sample_type_simplified == sample_type_selected) & (project_id == project_id_selected)))$participant_sample)
        ...
        samples_project = unique((metadata_df %>% filter((sample_type_simplified == sample_type_selected) & (project_id == project_id_selected) & (gender == sex)))$participant_sample)
